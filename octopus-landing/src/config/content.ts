...
export const siteContent: SiteContent = {
  ...
  games: [
    { id: 'game-01', src: assetPath('/media/games/game-01.mp4'), poster: assetPath('/media/games/game-01.webp'), label: 'Игра 1' },
    { id: 'game-02', src: assetPath('/media/games/game-02.mp4'), poster: assetPath('/media/games/game-02.webp'), label: 'Игра 2' },
    { id: 'game-03', src: assetPath('/media/games/game-03.mp4'), poster: assetPath('/media/games/game-03.webp'), label: 'Игра 3' },
    { id: 'game-04', src: assetPath('/media/games/game-04.mp4'), poster: assetPath('/media/games/game-04.webp'), label: 'Игра 4' },
    { id: 'game-05', src: assetPath('/media/games/game-05.mp4'), poster: assetPath('/media/games/game-05.webp'), label: 'Игра 5' },
  ],
  reviews: [
    { id: 'review-01', src: assetPath('/media/reviews/review-01.mp4'), poster: assetPath('/media/reviews/review-01.webp'), label: 'Отзыв 1' },
    { id: 'review-02', src: assetPath('/media/reviews/review-02.mp4'), poster: assetPath('/media/reviews/review-02.webp'), label: 'Отзыв 2' },
    { id: 'review-03', src: assetPath('/media/reviews/review-03.mp4'), poster: assetPath('/media/reviews/review-03.webp'), label: 'Отзыв 3' },
    { id: 'review-04', src: assetPath('/media/reviews/review-04.mp4'), poster: assetPath('/media/reviews/review-04.webp'), label: 'Отзыв 4' },
